...
export const Hero: React.FC = () => {
  ...
  return (
    <section className="flex-1 w-full relative flex flex-col justify-between px-6 md:px-12 py-8 md:py-16 overflow-hidden">
      ...
      <div className="absolute left-1/2 bottom-0 -translate-x-1/2 w-[85%] sm:w-[65%] md:w-[48%] lg:w-[40%] max-w-[500px] h-[65%] sm:h-[75%] md:h-[85%] z-0 flex items-end justify-center select-none overflow-hidden group/portrait pointer-events-auto">
        <img
      ...
      <div className="w-full flex-1 grid grid-cols-1 md:grid-cols-2 items-center gap-8 md:gap-0 relative z-10 pointer-events-none">
        ...
        {/* Right Side Content */}
        <div className="flex flex-col justify-end items-end text-right pointer-events-none md:h-full md:pb-24">
